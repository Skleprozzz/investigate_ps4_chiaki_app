...
static MunitResult test_encrypt(const MunitParameter params[], void *user)
{
	...
	err = ps4app_rpcrypt_encrypt(&rpcrypt, 0x0102030405060708, buf_a, sizeof(buf_a));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
	...
	err = ps4app_rpcrypt_encrypt(&rpcrypt, 0x0102030405060708, buf_b, sizeof(buf_b));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
	...
	err = ps4app_rpcrypt_encrypt(&rpcrypt, 0x0102030405060708, buf_c, sizeof(buf_c));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
	...
	err = ps4app_rpcrypt_encrypt(&rpcrypt, 0x0102030405060708, buf_d, sizeof(buf_d));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
...
static MunitResult test_decrypt(const MunitParameter params[], void *user)
{
	...
	err = ps4app_rpcrypt_decrypt(&rpcrypt, 0x0102030405060708, buf_a, sizeof(buf_a));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
	...
	err = ps4app_rpcrypt_decrypt(&rpcrypt, 0x0102030405060708, buf_b, sizeof(buf_b));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
	...
	err = ps4app_rpcrypt_decrypt(&rpcrypt, 0x0102030405060708, buf_c, sizeof(buf_c));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
	...
	err = ps4app_rpcrypt_decrypt(&rpcrypt, 0x0102030405060708, buf_d, sizeof(buf_d));
	if(err != PS4APP_ERR_SUCCESS)
		return MUNIT_ERROR;
